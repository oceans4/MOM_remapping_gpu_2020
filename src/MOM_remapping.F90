...
public build_reconstructions_1d, average_value_ppoly
public dzFromH1H2
public dumpGrid
...
!To compile this test program do:
!pgfortran MOM_error_handler.F90 PLM_functions.F90 polynomial_functions.F90 regrid_solvers.F90 regrid_edge_values.F90 MOM_remapping.F90 -o gputest
